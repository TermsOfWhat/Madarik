  ...
  return (
    <div className="dashboard-container">
      <div className="dashboard-header-skeleton">
        ...
        <Skeleton.Input active style={{ width: 450, height: 24, marginTop: 8 }} />
      </div>
        ...
        >
          {[1, 2, 3].map((_, index) => (
            ...
            >
              ...
              <div>
                <Skeleton.Input active style={{ width: 80, height: 28, marginBottom: 8 }} />
            ...
            {[1, 2].map((_, index) => (
              ...
              >
                <div style={{ flex: 1, padding: 16 }}>
                  <Skeleton.Input active style={{ width: "60%", height: 24, marginBottom: 8 }} />
        ...
        <AnimatePresence>
          {isCourseCompleted ? (
            <CourseCompletionCard
              ...
              onViewCertificate={() => navigate(`/certificate/${currentCourse.id}`)}
              onNextCourse={() => {
            ...
            >
              <div className="continue-learning-content">
                ...
                <div className="continue-learning-progress">
                  <Tooltip title={`${currentCourse.completedModules}% completed`} placement="top">
                    <CustomProgressBar
