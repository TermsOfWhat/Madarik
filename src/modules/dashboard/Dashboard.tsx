...
import { PlayCircle, BookOpen, Clock, BookMarked, Flame, ChevronRight } from "lucide-react"
...
const CustomProgressBar = ({ progress, totalModules, completedModules }: { progress: number, totalModules: number, completedModules: number }) => {
  ...
  return (
    <div className="custom-progress-container">
      <div className="custom-progress-bar" ref={progressBarRef}>
        ...
        />
        <div className="custom-progress-indicator" style={{ left: `${progress}%` }}>
          <span className="custom-progress-text">{progress}%</span>
        </div>
        <div className="custom-progress-icon">
          <Tooltip title={`${completedModules} of ${totalModules} modules completed`}>
            <AnimatedTrophy />
          </Tooltip>
        </div>
      </div>
