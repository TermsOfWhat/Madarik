      ...
      <div className="completion-content">
        ...
        <div className="completion-details">
          ...
          <div className="completion-actions">
            <Button type="primary" size="large" className="certificate-button" onClick={onViewCertificate}>
              View Certificate
            </Button>
            <Button type="default" size="large" className="next-course-button" onClick={onNextCourse}>
              Next Course <ChevronRight size={16} />
            </Button>
          </div>
        </div>
      </div>
